...
The dataset that was used can be downloaded here: *\<https://www.kaggle.com/datasets/nancyalaswad90/lung-cancer\>*

### Reference:

*\<Hong, Z. Q., & Yang, J. Y. (1991). Lung Cancer Dataset [Dataset]. Kaggle. Retrieved from https://www.kaggle.com/datasets/nancyalaswad90/lung-cancer/\>\
